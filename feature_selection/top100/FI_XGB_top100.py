...
def main():
    ...
    df_ranks.to_csv("result/top100_results/FI_XGB_top100_all_ranks.csv")
    ...
    summary.to_csv("result/top100_results/FI_XGB_top1000_summary.csv", index=False)
    summary.head(100).to_csv("result/top100_results/FI_XGB_top100.csv", index=False)

    print("Saved XGB top100 results", flush=True)
